...
export default function EditSitePage() {
  ...
  useEffect(() => {
    ...
    const foundSite = findSiteById(mockSites, siteId)
  ...
  }, [siteId, activeCustomerId, sessionLoading])
  ...
  const onSubmit = (data: SiteFormData) => {
    ...
    sessionStorage.setItem('updatedSite', JSON.stringify(updatedSite))
    sessionStorage.setItem('showUpdateSuccessMessage', 'true')
