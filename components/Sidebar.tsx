...
const navigationSections: NavSection[] = [
  {
    ...
    title: " Single Site",
    items: [
      { title: "Place New Order", subtitle: "Create and submit new orders", href: "/programs/single-site/place-order", icon: ClipboardPlus },
      { title: "Order History", subtitle: "View past orders and status", href: "/programs/single-site/order-history", icon: History },
      { title: "Sites", subtitle: "Manage your locations", href: "/programs/single-site/sites", icon: Building2 }
    ]
  }
]
