...
export const mockCustomers: Customer[] = [
  ...
  // Direct to Patient Customers
  {
    id: '16',
    customerId: 'DTP-CUST-001',
    customerName: 'Patient Services Network',
    contactName: 'Dr. Amanda Foster',
    contactEmail: 'a.foster@patientservices.com',
    contactPhone: '(415) 555-2001',
    status: 'active',
  ...
  },
  {
    ...
    customerName: 'Home Testing Alliance',
    contactEmail: 'info@hometestingalliance.com',
    contactPhone: '(310) 555-2002',
    status: 'active',
  ...
  },
  {
    ...
    customerName: 'Direct Care Partners',
    contactName: 'Dr. Lisa Chen',
    contactEmail: 'l.chen@directcarepartners.com',
    contactPhone: '(646) 555-2003',
    status: 'active',
  ...
  },
  {
    ...
    customerName: 'Patient Direct Systems',
    contactName: 'Robert Williams',
    contactEmail: 'r.williams@patientdirect.com',
    contactPhone: '(213) 555-2004',
    status: 'active',
  ...
  },
  {
    ...
    customerName: 'Home Health Services Group',
    contactName: 'Sarah Martinez',
    contactEmail: 's.martinez@homehealthservices.com',
    contactPhone: '(619) 555-2005',
    status: 'active',
  ...
  },
  {
    ...
    customerName: 'Patient Testing Solutions',
    contactName: 'Michael Davis',
    contactEmail: 'm.davis@patienttesting.com',
    contactPhone: '(858) 555-2006',
    status: 'active',
